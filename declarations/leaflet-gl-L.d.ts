...
declare namespace L {
    ...
    type LeafletBounds = [LatLngExpression, LatLngExpression] | LatLngBounds;
    ...
    abstract class DivOverlay extends Layer {
        ...
        constructor(
            optionsOrLatlng: DivOverlayOptions | LatLngExpression,
            sourceOrOptions?: Layer | DivOverlayOptions,
        );
        /**
    ...
    class Tooltip extends DivOverlay {
        ...
        constructor(
            optionsOrLatlng?: TooltipOptions | LatLngExpression,
            sourceOrOptions?: Layer | TooltipOptions,
        );
        /**
         * @internal
         */
    ...
    class Popup extends DivOverlay {
        ...
        constructor(
            optionsOrLatlng?: PopupOptions | LatLngExpression,
            sourceOrOptions?: Layer | PopupOptions,
        );
        /**
    ...
    class LeafletEvented {
        ...
        on<T extends keyof LeafletGlEventHandlerFnMap>(
            type: T,
            fn: LeafletGlEventHandlerFnMap[T],
            context?: object,
        ): this;
        on(eventMap: LeafletGlEventHandlerFnMap, context?: object): this;
        off<T extends keyof LeafletGlEventHandlerFnMap>(
            type: T,
            fn: LeafletGlEventHandlerFnMap[T],
            context?: object,
        ): this;
         ...
         */
        once<T extends keyof LeafletGlEventHandlerFnMap>(
            type: T,
            fn: LeafletGlEventHandlerFnMap[T],
            context?: object,
        ): this;
    ...
    abstract class Layer extends LeafletEvented {
         ...
         */
        bindTooltip(
            content: ((layer: Layer) => OverlayContent) | OverlayContent | Tooltip,
    ...
    class SourceCache extends Evented {
         ...
         */
        tilesIn(
            pointQueryGeometry: Array<Point>,
            maxPitchScaleFactor: number,
            has3DLayer: boolean,
        ): TileResult[];
    ...
    type PreRenderRasterTileCallback = (
        gl: WebGL2RenderingContext | WebGLRenderingContext,
        program: WebGLProgram,
        tileCoords: CoordsType,
        layerId: string,
    ) => void;
    type PostRenderRasterTileCallback = (
        gl: WebGL2RenderingContext | WebGLRenderingContext,
        tileCoords: CoordsType,
    ) => void;
     ...
     */
    type FlyToOptions = AnimationOptions &
        CameraOptions & {
            /**
    ...
    type EaseToOptions = AnimationOptions &
        CameraOptions & {
    ...
    class RasterTileSource extends Evented implements Source {
        ...
        constructor(
            id: string,
            options: RasterSourceSpecificationWithRetina,
    ...
    class MapLibreMap extends Camera {
        ...
        addSource(
            id: string,
            source: SourceSpecification | RasterSourceSpecificationWithRetina,
        ): this;
        /**
    ...
    type FitBoundsOptionsLeaf = ZoomOptions &
        PanOptions & {
    ...
    class Circle extends CircleMarker {
        ...
        constructor(
            ...
            options?: CircleMarkerOptions | number,
            legacyOptions?: CircleMarkerOptions,
        );
        /**
     ...
     */
    function polygon(
        latlngs: LatLngExpressionMultiPolygonShape,
    ...
    class KML extends FeatureGroup {
        ...
        protected _parseTrack(
            _unused: never,
            xml: XMLDocument | Element,
            options: ParsedStyle,
        ): Polyline | void;
        protected _parsePoint(
            line: Element,
            _xml: XMLDocument | Element,
            options: ParsedStyle,
        ): KMLMarker | void;
        protected _parsePolygon(
            line: Element,
            _xml: XMLDocument | Element,
            options: ParsedStyle,
        ): Polygon | void;
    ...
    type GPXOptions = SpeedSplitOptions &
        MarkerOptions &
        PolylineOptions &
        LayerOptions & {
            /**
     ...
     */
    function createTileMesh<T extends IndicesType>(
